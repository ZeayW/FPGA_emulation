...
REQUIRED_FIRST_PARTY_NATIVE_FILES = (
    ...
    "src/emuflow/xilinx_primitives.py",
    "src/emuflow/xilinx_placer_capability.py",
    "src/emuflow/dreamplacefpga_candidate.py",
    "src/emuflow/dreamplacefpga_interchange.py",
    ...
    "src/emuflow/xilinx_preplacement_timing.py",
    "src/emuflow/xilinx_opensta.py",
    ...
    "schemas/xilinx-physical-macro-contract-v1.schema.json",
    "schemas/xilinx-placement-v1.schema.json",
    "schemas/xilinx-route-db-v1.schema.json",
    ...
    "tests/test_xilinx_placer_capability.py",
    "tests/test_dreamplacefpga_candidate.py",
    "tests/test_dreamplacefpga_interchange.py",
    "tests/test_xilinx_preplacement_timing.py",
    "tests/test_xilinx_packing.py",
    "tests/test_xilinx_physical_macros.py",
    "tests/test_xilinx_openparf.py",
    "tests/test_xilinx_placement.py",
    "tests/test_xilinx_rwroute.py",
    "tests/test_xilinx_opensta.py",
